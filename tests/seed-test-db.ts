...
export async function seedTestDb() {
  ...
  await prisma.user.createMany({
    data: [
      ...
      { id: SEED_IDS.customer1, email: 'customer1@test.com', password, name: 'Customer One', role: ROLES.CUSTOMER },
      { id: SEED_IDS.customer2, email: 'customer2@test.com', password, name: 'Customer Two', role: ROLES.CUSTOMER },
      { id: SEED_IDS.courier1, email: 'courier1@test.com', password, name: 'Courier One', role: ROLES.COURIER, serviceArea: 'Dhaka' },
      { id: SEED_IDS.courier2, email: 'courier2@test.com', password, name: 'Courier Two', role: ROLES.COURIER, serviceArea: 'Chittagong' },
    ]
  });
  ...
  await prisma.pricingRule.createMany({
    data: [
      { id: SEED_IDS.rule1, zoneId: null, serviceType: 'STANDARD', basePrice: 50, pricePerKg: 10, maxWeight: 50 },
      { id: SEED_IDS.rule2, zoneId: null, serviceType: 'EXPRESS', basePrice: 100, pricePerKg: 20, maxWeight: 30 },
      { id: SEED_IDS.rule3, zoneId: SEED_IDS.zone1, serviceType: 'STANDARD', basePrice: 60, pricePerKg: 12, maxWeight: 50 },
      { id: SEED_IDS.rule4, zoneId: SEED_IDS.zone1, serviceType: 'EXPRESS', basePrice: 120, pricePerKg: 25, maxWeight: 30 },
    ]
  });
}
