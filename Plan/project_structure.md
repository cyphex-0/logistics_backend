...
| **Exact wording**      | _"Cash on Delivery, Pay Later, or fake manual status updates are NOT accepted."_ (project_requirements line 28)                                                            |
...
| **Exact wording**      | _"Simulated/fake payments are NOT accepted."_ (README line 45)                                                                                                    |
...
| **Exact wording**      | _"regular e-commerce clones or projects already covered in this course are not allowed"_ (README line 26)                  |
...
| **Exact wording**      | _"Each project must have 3 fixed primary roles"_ (project_requirements line 27); _"strict role-based authorization for 3 distinct roles"_ (README line 43) |
...
| **Exact wording**    | _"Each project must implement and document at least 20 meaningful API endpoints"_ |
...
| **Exact wording**    | _"Implement authentication (Email/Password + GCP Social Login)"_ (README line 43) |
...
| **Exact wording**    | _"Implement Soft Deletes (e.g., using a deletedAt timestamp) instead of hard deleting records"_                                     |
...
| **Exact wording**    | _"Implement Audit Logs / Activity Tracking for critical actions"_      |
